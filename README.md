...
同一张照片，一部分留在原处，一部分成为色纸上的碎片。下面两张作品分别展示上下和左右拼接。

| 方块 · 上下拼接                                                                                   | 圆点 · 左右拼接                                                                                         |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| ![街景中的方形切片散落在深灰蓝色纸上，与下方照片中的方孔一一对应](docs/images/example-square.png) | ![冰箱照片中的圆形切片散落在左侧红色色纸上，与右侧照片中的圆孔一一对应](docs/images/example-circle.png) |
...
README 的界面封面和两张作品案例收录于 `docs/images/`，是选定用于公开展示的图片；应用启动和测试不依赖这些图片。
